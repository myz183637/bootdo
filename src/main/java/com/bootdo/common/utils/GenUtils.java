...
public class GenUtils {
    ...
    public static String getFileName(String template, String classname, String className, String packageName) {
        String packagePath = "so" + File.separator + "java" + File.separator;
...
//		}
        ...
        if (template.contains("Mapper.xml.vm")) {
            return "so" + File.separator + "resources" + File.separator + "mapper" + File.separator + packageName + File.separator + className + "Mapper.xml";
        }

        if (template.contains("list.html.vm")) {
            return "so" + File.separator + "resources" + File.separator + "templates" + File.separator
        ...
        if (template.contains("list.js.vm")) {
            return "so" + File.separator + "resources" + File.separator + "static" + File.separator + "js" + File.separator
