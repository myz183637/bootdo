...
(/** @lends <global> */function( $ ) {
	...
	/**
	 * Provide backwards compatibility for the so DT options. Note that the new
	...
	DataTable.models.oSettings = {
		...
		/**
		 * The TABLE node for the so table
		 *  @type node
		 *  @default null
		 */
		"nTable": null,
	...
	DataTable.ext = _ext = {
		 ...
		 *   (false)
		 *
		 * Note that as with the so search ability in DataTables, technically this
